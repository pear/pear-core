...
$phpunit->assertEquals(false, PEAR_Installer_Role::factory($pf2, 'php', $config), 'php extsrc');
...
$phpunit->assertEquals(false, PEAR_Installer_Role::factory($pf2, 'php', $config), 'php extbin');
