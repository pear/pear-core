...
$phpunit->assertErrors(array(
    array('package' => 'PEAR_PackageFile_v2', 'message' => 'File "5" in directory "<dir name="/">" has invalid role "php", should be one of data, doc, script, src, test'),
    array('package' => 'PEAR_PackageFile_v2', 'message' => 'File "6" in directory "<dir name="/">" has invalid role "ext", should be one of data, doc, script, src, test'),
