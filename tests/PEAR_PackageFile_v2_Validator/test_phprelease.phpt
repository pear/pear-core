...
$phpunit->assertErrorsF(array(
    array('package' => 'PEAR_PackageFile_v2', 'message' => 'File "1" in directory "<dir name="/">" has invalid role "src", should be one of data, doc, php, script, test, www'),
    array('package' => 'PEAR_PackageFile_v2', 'message' => 'File "6" in directory "<dir name="/">" has invalid role "ext", should be one of data, doc, php, script, test, www'),
), '3');
echo 'tests done';
?>
--CLEAN--
