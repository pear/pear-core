...
$phpunit->assertErrors(array(
    ...
    array('package' => 'PEAR_PackageFile_v2', 'message' => '<ignore> is not allowed inside global <contents>, only inside <phprelease>/<extbinrelease>'),
    array('package' => 'PEAR_PackageFile_v2', 'message' => '<install> is not allowed inside global <contents>, only inside <phprelease>/<extbinrelease>'),
), '1');
echo 'tests done';
?>
--EXPECT--
