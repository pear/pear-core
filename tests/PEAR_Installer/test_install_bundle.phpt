...
$phpunit->assertEquals('Bar', $result[0]->getPackage(), 'right package 1');
$phpunit->assertEquals('pear.php.net', $result[0]->getChannel(), 'right channel 1');
$phpunit->assertEquals('Foobar', $result[1]->getPackage(), 'right package 2');
$phpunit->assertEquals('smork', $result[1]->getChannel(), 'right channel 2');
$phpunit->assertEquals('PEAR1', $result[2]->getPackage(), 'right package');
$phpunit->assertEquals('pear.php.net', $result[2]->getChannel(), 'right channel');
