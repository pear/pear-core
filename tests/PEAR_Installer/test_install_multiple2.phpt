--TEST--
PEAR_Installer->install() with multiple local packages [preferred_state = alpha]
--SKIPIF--
<?php
...
$pathtopackagexml = dirname(__FILE__)  . DIRECTORY_SEPARATOR .
    'packages'. DIRECTORY_SEPARATOR . 'PEAR1-1.5.0a1.tgz';
$pathtopackagexml2 = dirname(__FILE__)  . DIRECTORY_SEPARATOR .
    'packages'. DIRECTORY_SEPARATOR . 'Bar-1.5.2.tgz';
$pathtopackagexml3 = dirname(__FILE__)  . DIRECTORY_SEPARATOR .
...
$phpunit->assertEquals(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'packages' . DIRECTORY_SEPARATOR .
    'PEAR1-1.5.0a1.tgz',
