...
$phpunit->assertEquals(array (
  ...
  array (
    ...
    array (
      'role' => 'php',
      'installed_as' => $config->_prependPath($temp_path . DIRECTORY_SEPARATOR . 'php' . DIRECTORY_SEPARATOR . 'foo.php', $temp_path . DIRECTORY_SEPARATOR . 'installroot'),
    ),
  ),
  'xsdversion' => '1.0',
  'package' => 'PEAR',
...
$phpunit->assertFileExists($config->_prependPath($temp_path . DIRECTORY_SEPARATOR . 'php' . DIRECTORY_SEPARATOR . 'foo.php', $temp_path . DIRECTORY_SEPARATOR . 'installroot'),
    'installed file');
