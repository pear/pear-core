...
$phpunit->assertErrors(array(
    array('package' => 'PEAR_PackageFile_v2', 'message' => 'File "validv1.xml" in directory "<dir name="/">" has invalid role "ext", should be one of data, doc, php, script, src, test, www'),
), 'invalid packagexml 1');
$phpunit->assertEquals(array (
  0 => 
  array (
    'info' => 'File "validv1.xml" in directory "<dir name="/">" has invalid role "ext", should be one of data, doc, php, script, src, test, www',
    'cmd' => 'no command',
  ),
  1 => 
  array (
