...
$phpunit->assertTrue($reg->updatePackage("pkg2", array("version" => "2.1")),
    'update pkg2 return');

$phpunit->assertRegEquals('dumping registry...
channel pear.php.net:
pkg1: version="1.0" filelist=array(pkg1-1.php[role=php],pkg1-2.php[role=php,baseinstalldir=pkg1]) _lastmodified is set
pkg2: version="2.1" filelist=array(pkg2-1.php[role=php],pkg2-2.php[role=php,baseinstalldir=pkg2]) _lastmodified is set
pkg3: version="3.0" filelist=array(pkg3-1.php[role=php],pkg3-2.php[role=php,baseinstalldir=pkg3]) _lastmodified is set
dump done
...
$phpunit->assertTrue($reg->updatePackage("pkg3", array("version" => "3.1b1", "status" => "beta"))
    , 'update pkg3 return');
$phpunit->assertRegEquals('dumping registry...
channel pear.php.net:
pkg1: version="1.0" filelist=array(pkg1-1.php[role=php],pkg1-2.php[role=php,baseinstalldir=pkg1]) _lastmodified is set
