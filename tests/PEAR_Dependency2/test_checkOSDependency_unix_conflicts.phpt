...
$phpunit->assertErrors(array(
    array('package' => 'PEAR_Error', 'message' => 'Cannot install channel://pear.php.net/mine on any Unix system'),
),'linux');
...
$phpunit->assertErrors(array(
    array('package' => 'PEAR_Error', 'message' => 'Can only install channel://pear.php.net/mine on a Unix system'),
),'windows');
...
$phpunit->assertEquals(array('warning: Can only install channel://pear.php.net/mine on a Unix system'), $result, 'nodeps');
...
$phpunit->assertEquals(array('warning: Can only install channel://pear.php.net/mine on a Unix system'), $result, 'force');
