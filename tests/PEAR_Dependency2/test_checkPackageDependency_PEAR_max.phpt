...
$phpunit->assertErrors(array(
    array('package' => 'PEAR_Error',
          'message' => 'channel://pear.php.net/mine requires package "foo" (version >= 1.1, version <= 1.9), installed version is 1.10')
), 'max');
...
$phpunit->assertEquals(array (
  0 => 'warning: channel://pear.php.net/mine requires package "foo" (version >= 1.1, version <= 1.9), installed version is 1.10',
), $result, 'max nodeps');
