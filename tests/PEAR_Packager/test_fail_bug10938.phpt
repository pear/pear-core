--TEST--
PEAR_Packager->package() failure with files containing . or ..
--SKIPIF--
<?php
...
copy(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'packagefiles' . DIRECTORY_SEPARATOR .
    'bug10938v1.xml', $temp_path . DIRECTORY_SEPARATOR . 'package.xml');
$ret = $packager->package($temp_path . DIRECTORY_SEPARATOR . 'package.xml');
$phpunit->assertErrors(array(
    array('package' => 'PEAR_PackageFile_v1', 'message' => 'File "sunger/./foo.dat" cannot start with ".", cannot package or install'),
    array('package' => 'PEAR_PackageFile_v1', 'message' => 'File "hi/../../bad/blah.php" cannot start with ".", cannot package or install'),
    array('package' => 'PEAR_PackageFile_v1', 'message' => 'File "hi/../../bad/blah.php [baseinstalldir ../oops]" cannot start with ".", cannot package or install'),
    array('package' => 'PEAR_PackageFile_v1', 'message' => 'File "foo1.php [installed as ../../../../etc/passwd]" cannot start with ".", cannot package or install'),
...
$phpunit->assertEquals(array (
  array (
    0 => 'Error: File "hi/../../bad/blah.php [baseinstalldir ../oops]" cannot start with ".", cannot package or install',
    1 => true,
  ),
  1 => 
  array (
    0 => 'Error: File "hi/../../bad/blah.php" cannot start with ".", cannot package or install',
    1 => true,
  ),
  2 => 
  array (
    0 => 'Error: File "foo1.php [installed as ../../../../etc/passwd]" cannot start with ".", cannot package or install',
    1 => true,
  ),
  3 => 
  array (
    0 => 'Error: File "sunger/./foo.dat" cannot start with ".", cannot package or install',
    1 => true,
  ),
  4 => 
  array (
