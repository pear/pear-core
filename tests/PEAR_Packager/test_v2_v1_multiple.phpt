--TEST--
PEAR_Packager->package() success, package.xml 2.0 and package.xml 1.0 equivalent
--SKIPIF--
<?php
...
// normal
$ret = $packager->package($temp_path . DIRECTORY_SEPARATOR . 'validv2.xml', true,
    $temp_path . DIRECTORY_SEPARATOR . 'equivv1.xml');
